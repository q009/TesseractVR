...
struct model
{
    ...
    virtual int intersect(int anim, int basetime, int basetime2, const vec &pos, float yaw, float pitch, float roll, dynent *d, modelattach *a, float size, const vec &o, const vec &ray, float &dist, int mode, const quat &baseorient = quat(0, 0, 0, 1)) = 0;
    virtual void render(int anim, int basetime, int basetime2, const vec &o, float yaw, float pitch, float roll, dynent *d, modelattach *a = NULL, float size = 1, const vec4 &color = vec4(1, 1, 1, 1), const quat &baseorient = quat(0, 0, 0, 1)) = 0;
    virtual bool load() = 0;
